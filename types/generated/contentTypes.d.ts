...
export interface ApiEventoEvento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dia_da_semana: Schema.Attribute.Enumeration<
      [
        'Domingo',
        'Segunda-feira',
        'Terca-feira',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recorrencia: Schema.Attribute.Enumeration<
      ['Nao se repete', 'Semanalmente']
    >;
    titulo: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiMembrosConselhoMembrosConselho
  extends Struct.CollectionTypeSchema {
  collectionName: 'membros_conselhos';
  info: {
    displayName: 'Membros do Conselho';
    pluralName: 'membros-conselhos';
    singularName: 'membros-conselho';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::membros-conselho.membros-conselho'
    > &
      Schema.Attribute.Private;
    nome: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMidiaMidia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::midia.midia'> &
      Schema.Attribute.Private;
    pregador: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    serie_tematica: Schema.Attribute.String;
